...
A native macOS Menu Bar application built with Swift and SwiftUI for tracking AI token quota usage on Google Antigravity (`agy`), Gemini, Claude, and GPT models.

![aiUsageBar Preview](assets/antigravity_logo_52.png)

## Features

- **Native macOS SwiftUI App**: Built with AppKit and SwiftUI (`NSVisualEffectView` glass UI).
- **Zero Latency**: Background cached execution (< 1ms UI response).
- **30-Day Token Usage Chart**: Emerald Green bar chart visualization matching Apple HIG aesthetics.
